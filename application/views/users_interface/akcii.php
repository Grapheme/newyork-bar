		...
		<div id="main" role="main">
			...
			<article class="first cf">
				...
				<section class="afisha-columns specials cf">
					<aside>
						<img src="<?=$baseurl;?>images/menu/steak-discount.jpg" alt="Крутящиеся бокалы" />
					</aside>
					<div class="column">
						<h2>Скидка 10% на всей стейки *</h2>
						<p>
							При заказе любого стейка из меню вы получаете скидку <nobr>10% на стейк</nobr> и 
							бокал вина в подарок по выбору нашего сомелье.
						</p>
						<p>
							<em>Пожалуйста распечатайте стикер и принесите с собой в ресторан</em>
						</p>
					</div>
				</section>
				...
				<section class="afisha-columns specials cf">
					...
					<div class="column">
						...
						<p>
							Все просто. Вы берете бокал с односолодовым виски, ставите на столе и легким 
							движением руки придаете бокалу вращательное движение...
						</p>
						<p>
