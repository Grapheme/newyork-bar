			...
			<div id="carousel" class="cf" style="margin-bottom: 0;">
				<div class="photo-wrapper clear">
					...
					<a class="promo-banner" href="<?=$baseurl;?>menu">
						<img src="<?=$baseurl;?>images/menu/1.jpg" alt="" />
					</a>
					<a class="promo-banner" href="<?=$baseurl;?>menu">
						<img src="<?=$baseurl;?>images/menu/2.jpg" alt="" />
					</a>
					<a class="promo-banner" href="<?=$baseurl;?>menu">
						<img src="<?=$baseurl;?>images/menu/steak-discount.jpg" alt="" />
					</a>
					<a class="promo-banner" href="<?=$baseurl;?>menu">
						<img src="<?=$baseurl;?>images/afisha/ny_steak_site.jpg" alt="" />
					</a>
					<!--
					<a class="promo-banner" href="<?=$baseurl;?>menu">
						<img src="<?=$baseurl;?>images/tinkoff.jpg" alt="" />
					</a>
